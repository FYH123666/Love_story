        ...
        if ($_FILES['images']['error'][$key] === UPLOAD_ERR_OK) {
            ...
            if (!empty($upload['success'])) {
                ...
                $imageId = $db->insert('album_images', [
                    ...
                    'thumb_url'      => $upload['variants']['thumb_url'] ?? null,
                    'medium_url'     => $upload['variants']['medium_url'] ?? null,
                    'webp_url'       => $upload['variants']['webp_url'] ?? null,
                    'thumb_webp_url' => $upload['variants']['thumb_webp_url'] ?? null,
                    'medium_webp_url'=> $upload['variants']['medium_webp_url'] ?? null,
